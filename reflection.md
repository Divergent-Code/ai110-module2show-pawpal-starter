...
- Describe one tradeoff your scheduler makes:
  Our `detect_conflicts` method only checks for *exact* time matches instead of calculating overlapping duration windows (e.g., checking if an 08:00 task taking 45 minutes overlaps an 08:30 task).
